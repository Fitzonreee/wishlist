...
class Wishlist extends CI_Model {
	...
	public function get_all($id){
		$query = "SELECT product_id, name, description, image_url, category_id, users.first_name FROM wishlists LEFT JOIN products ON wishlists.product_id = products.id LEFT JOIN users ON users.id = wishlists.user_id WHERE user_id = ?";
